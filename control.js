...
cron.schedule('00 30 00 * * Monday' , async () =>{
...
getData().then(async (data) => { 
 console.log(data)
   ...
   clubs = await xlsx.utils.sheet_to_json(ws);


})
clubs = await clubs.sort((a,b) => (a.Trophies_Gained > b.Trophies_Gained) ? -1 : ((b.Trophies_Gained > a.Trophies_Gained) ? 1 : 0)); 
